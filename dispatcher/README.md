...
- ~/dev/repository/git/aem-servers/sync_dispatcher_src.sh ~/dev/repository/git/aem-vanilla/dispatcher/src ~/dev/repository/git/aem-servers/dispatcher-sdk-2.0.248/src
